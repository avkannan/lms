...
import com.um.lms.sb.exception.NoSuchlookupException;
import com.um.lms.sb.model.impl.lookupImpl;
import com.um.lms.sb.model.impl.lookupModelImpl;
...
public class lookupPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.um.lms.sb.model.lookup"),
			true);
	}
