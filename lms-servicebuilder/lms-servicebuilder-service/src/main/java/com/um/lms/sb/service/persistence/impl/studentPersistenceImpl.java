...
import com.um.lms.sb.exception.NoSuchstudentException;
import com.um.lms.sb.model.impl.studentImpl;
import com.um.lms.sb.model.impl.studentModelImpl;
...
public class studentPersistenceImpl
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			studentModelImpl.DISPLAYNAME_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.um.lms.sb.model.student"),
			true);
	}
