...
import com.um.lms.sb.service.lendingService;
...
/**
 * Provides the base implementation for the lending remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.um.lms.sb.service.impl.lendingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.um.lms.sb.service.impl.lendingServiceImpl
 * @generated
 */
public abstract class lendingServiceBaseImpl
	extends BaseServiceImpl
	implements lendingService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>lendingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.um.lms.sb.service.lendingServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			lendingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		lendingService = (lendingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return lendingService.class.getName();
	}
	...
	@Reference
	protected com.um.lms.sb.service.lendingLocalService lendingLocalService;
