...
/**
 * Provides the local service interface for lending. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see lendingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface lendingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link lendingLocalServiceUtil} to access the lending local service. Add custom service methods to <code>com.um.lms.sb.service.impl.lendingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
